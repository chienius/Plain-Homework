...
<div id="container">
  ...
  <form method="post" action="<?=site_url('login/action') ?>">
    <input name="stuid" style="border:solid #b5b5b5 1px; width: 300px; height: 30px; font-size: 24px;font-family:'黑体'" type="text" value="学籍号" onfocus="if(this.value=='学籍号'){this.value=''}" /><br /><br />
